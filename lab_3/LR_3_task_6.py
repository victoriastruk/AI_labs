...
train_sizes_poly, train_scores_poly, validation_scores_poly = learning_curve(poly_model, X_poly, y,
                                                                             train_sizes=[0.1, 0.3, 0.5, 0.7, 0.9], cv=2)
...
plt.title('Криві навчання для поліноміальної регресії (ступінь {})'.format(degree))
plt.xlabel('Розмір тренувального набору')
plt.ylabel('Помилка')
plt.legend()
plt.grid(True)
